<%@ Page Title="" Language="C#" MasterPageFile="~/masterpageauction.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="project.WebForm1" %>
...
<body style="width: 1345px; height: 376px">
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style20" style="width: 100%"></td>
            <td class="auto-style64">last name:</td>
            <td class="auto-style22"></td>
        </tr>
        <tr>
            <td class="auto-style54" style="width: 100%"></td>
        ...
        <tr>
            <td class="auto-style23" style="width: 100%"></td>
            <td class="auto-style67">Password:</td>
            <td class="auto-style25"></td>
        </tr>
        <tr>
            <td class="auto-style51" style="width: 100%"></td>
        ...
        <tr>
            <td class="auto-style20" style="width: 100%"></td>
            <td class="auto-style64">Email:</td>
            <td class="auto-style22"></td>
        </tr>
        <tr>
            <td class="auto-style60" style="width: 100%"></td>
            <td class="auto-style69">
                <asp:TextBox ID="TextBox5" runat="server" Width="372px" CssClass="textbox-style" TextMode="Email"></asp:TextBox>
                <strong>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="TextBox5" CssClass="auto-style63" Display="Dynamic" ErrorMessage="E-mail is required!" ForeColor="Red"></asp:RequiredFieldValidator>
                <br/>
        ...
        <tr>
            <td class="auto-style45" style="width: 100%"></td>
            <td class="auto-style70">Date Of Birth:</td>
            <td class="auto-style47"></td>
        </tr>
        <tr>
            <td class="auto-style48" style="width: 100%"></td>
